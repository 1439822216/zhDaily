...
public class OkHttpUtil {
     ...
     * @return
     */
    public  Response postDataSynToNetTojson(String url,String jsonStr) {
        //1构造RequestBody
    ...
    /***
     * post请求，异步方式，提交json数据，是在子线程中执行的，需要切换到主线程才能更新UI
     * @param url
     * @param jsonStr
     * @param myNetCall
     */
    public  void postDataAsynToNetToJson(String url, String jsonStr, final MyNetCall myNetCall) {
        //1构造RequestBody
        RequestBody body=RequestBody.create(JSON,jsonStr);
        //2 构造Request
        Request.Builder requestBuilder = new Request.Builder();
